...
public class Matrix3 {
    ...
    static void compute_svd(double[] m, double[] outScale, double[] outRot) {
        ...
        /*
          Teras.LOGGER.info("t1 is \n" + t1);
          Teras.LOGGER.info("t1="+t1[0]+" "+t1[1]+" "+t1[2]);
          Teras.LOGGER.info("t1="+t1[3]+" "+t1[4]+" "+t1[5]);
          Teras.LOGGER.info("t1="+t1[6]+" "+t1[7]+" "+t1[8]);

          Teras.LOGGER.info("t2 is \n" + t2);
          Teras.LOGGER.info("t2="+t2[0]+" "+t2[1]+" "+t2[2]);
          Teras.LOGGER.info("t2="+t2[3]+" "+t2[4]+" "+t2[5]);
          Teras.LOGGER.info("t2="+t2[6]+" "+t2[7]+" "+t2[8]);
          */
    ...
    static void svdReorder(double[] m, double[] t1, double[] t2, double[] scales, double[] outRot, double[] outScale) {
        ...
        if (almostEqual(Math.abs(scales[0]), Math.abs(scales[1])) && almostEqual(Math.abs(scales[1]), Math.abs(scales[2]))) {
            ...
            Teras.LOGGER.info("rot="+rRot[3]+" "+rot[4]+" "+rot[5]);
            Teras.LOGGER.info("rot="+rot[6]+" "+rot[7]+" "+rot[8]);
            */
