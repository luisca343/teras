...
public class Carrera {
        ...
        new Thread(() -> {
            try {
                while (estado == EstadoCarrera.EN_CURSO){
                    ...
                    for (Participante participante : participantes) {
                        // Position update removed: CMessageCambioPosicion was in deleted clientOld package
                    }
                    Thread.sleep(1000);
                }
            } catch (InterruptedException e) {
    ...
    private void finalizar() {
        ...
        for (Participante participante : participantes) {
            ...
            // Position reset removed: CMessageCambioPosicion was in deleted clientOld package
        }
