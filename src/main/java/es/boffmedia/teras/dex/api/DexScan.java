 ...
 * the web's {@code openDex(dex, form)} takes. {@code palette} is Pixelmon's palette name; Cobblemon has
 * no palettes and reports {@code shiny}/{@code none}.</p>
 */
public record DexScan(int dex, String form, String palette) {
     ...
     */
    public static DexScan of(int dex, String form, String palette) {
        return new DexScan(dex, name(form), name(palette));
    }
